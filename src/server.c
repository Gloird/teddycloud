...
request_type_t request_paths[] = {
    ...
    {REQ_POST, "/api/encodeQueue/create", SERTY_WEB, &handleApiEncodeQueueCreate},
    {REQ_POST, "/api/encodeQueue/add", SERTY_WEB, &handleApiEncodeQueueAdd},
    {REQ_GET, "/api/encodeQueue/list", SERTY_WEB, &handleApiEncodeQueueList},
    {REQ_POST, "/api/encodeQueue/start", SERTY_WEB, &handleApiEncodeQueueStart},
    {REQ_POST, "/api/encodeQueue/remove", SERTY_WEB, &handleApiEncodeQueueRemove},
